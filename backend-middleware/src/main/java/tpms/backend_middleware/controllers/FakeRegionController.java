...
@RestController()
@RequestMapping(path = "/fake/api/v1/regions", produces = "application/json")
@CrossOrigin("*")
public class FakeRegionController {
    private final RegionRepository repository;

    @Autowired
    public FakeRegionController(RegionRepository repository) {
